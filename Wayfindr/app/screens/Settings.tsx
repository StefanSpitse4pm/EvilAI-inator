      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          <SettingsItem
            ...
            icon="help-outline"
  onPress={() => {
    toast.info('Opening Help / FAQ...');
    Linking.openURL('https://www.nhlstenden.com/faq');
  }}
            colors={colors}
          />
          <SettingsItem
            ...
            icon="bug-outline"
  onPress={() => {
    toast.info('Opening Report page...');
    Linking.openURL('https://www.nhlstenden.com/locaties');
  }}
            colors={colors}
          />
          <SettingsItem
            ...
            icon="bulb-outline"
  onPress={() => {
    toast.info('Opening Suggest a Feature page...');
    Linking.openURL('https://www.nhlstenden.com/over-nhl-stenden/niet-tevreden');
  }}
            colors={colors}
          />
        </View>
        ...
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <SettingsItem
            ...
            onPress={() =>{
              ...
              Linking.openURL('https://www.nhlstenden.com/');
}}
            colors={colors}
          />
          <SettingsItem
